...
<head>
    ...
    <title>Система поддержки принятия решения выбора оборудования виртуальной реальности</title>
            ...
            <div class="right__container">
                <fieldset id="form1">
                    <div class="sub__title__container ">
                        ...
                        <p>Please fill the details below so that we can we can get in contacat with you about our
                            product</p>
                    </div>
                    <div class="input__container"> <label for="name">Enter your name</label> <input type="text"> <a
                ...
                <fieldset class="active__form" id="form2">
                    <div class="sub__title__container">
                        ...
                        <p>Please let us know what type of business best describes you as entreprenuer or businessman.
                        </p>
                    </div>
                    <div class="input__container">
                        ...
                        <div class="buttons"> <a class="prev__btn" onclick="prevForm();">Back</a> <a class="nxt__btn"
                ...
                <fieldset class="active__form" id="form5">
                    <div class="sub__title__container">
                        ...
                        <p>Thanks for completing the form and for your time.Plss enter your email below and submit the
                            form</p>
                    </div>
